                          ...
                          <div className="social-boxer">
                            <div className="social">
                              ...
                              <a href="https://discord.gg/AJtE9Zd" target="_blank" className="social_right_icon">
                                <img title="Discord Channel" src={require("../../images/icons/if_discord_2308078.png")}/>
                              </a>
                            </div>
                            <div className="social-data">
                              ...
                              <div className="social_box">
                                ...
                                <a href="https://www.instagram.com/solution_token/" target="_blank" className="sociallink sociallink_inactive" >
                                  <span className="tooltiptext"><FormattedMessage {...messages.working}/></span>
                                  <img title="Instagram" src={require("../../images/icons/if_Popular_Social_Media-07_2329236.png")}/>
                                </a>
                                <a href="javascript:;" onClick={this.handleContact.bind(this, "SC")} className="sociallink sociallink_inactive">
                                  <span className="tooltiptext"><FormattedMessage {...messages.working}/></span>
                                  <img title="Snapchat"  src={require("../../images/icons/if_snapchat_386706.png")}/>
                                </a>
                                ...
                                <a href="https://www.reddit.com/user/SolutionToken/"  target="_blank" className="sociallink sociallink_inactive"  >
                                  <span className="tooltiptext"><FormattedMessage {...messages.working}/></span>
...
{/*</svg>*/}
                  ...
                  <SkyLight
                    hideOnOverlayClicked={true}
                    ref={ref => this.snapContact = ref}>
                    <div className="SC community-popup">
                      {/*<h3>Snapchat</h3>*/}
                      <img className="snap-chat" src={require("../../images/snapchat.png")}/>
                      <p>Username: <b>solutiontoken</b>
                        {/*<span>*/}
                                                    {/*<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 866 864">*/}
{/*<defs>*/}
  {/*</defs>*/}
